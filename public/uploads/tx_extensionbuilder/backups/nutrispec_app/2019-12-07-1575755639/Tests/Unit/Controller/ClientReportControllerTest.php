...
{
    /**
     * @var \GroupProject\NutrispecApp\Controller\ClientReportController
     */
    ...
    {
        parent::setUp();
        $this->subject = $this->getMockBuilder(\GroupProject\NutrispecApp\Controller\ClientReportController::class)
    ...
    public function listActionFetchesAllClientReportsFromRepositoryAndAssignsThemToView()
    {
        ...
        $clientReportRepository = $this->getMockBuilder(\GroupProject\NutrispecApp\Domain\Repository\ClientReportRepository::class)
            ->setMethods(['findAll'])
            ->disableOriginalConstructor()
            ->getMock();
    ...
    {
        $clientReport = new \GroupProject\NutrispecApp\Domain\Model\ClientReport();
