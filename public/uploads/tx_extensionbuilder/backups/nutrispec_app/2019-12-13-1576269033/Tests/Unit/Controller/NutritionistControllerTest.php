...
{
    /**
     * @var \GroupProject\NutrispecApp\Controller\NutritionistController
     */
    ...
    {
        parent::setUp();
        $this->subject = $this->getMockBuilder(\GroupProject\NutrispecApp\Controller\NutritionistController::class)
    ...
    public function listActionFetchesAllNutritionistsFromRepositoryAndAssignsThemToView()
    {
        ...
        $nutritionistRepository = $this->getMockBuilder(\GroupProject\NutrispecApp\Domain\Repository\NutritionistRepository::class)
            ->setMethods(['findAll'])
            ->disableOriginalConstructor()
            ->getMock();
    ...
    {
        $nutritionist = new \GroupProject\NutrispecApp\Domain\Model\Nutritionist();
